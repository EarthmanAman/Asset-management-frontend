...
import ConsumableTable from "../components/consumables_table";


class ConsumableAssets extends React.Component {
    state = {
        "totals": [],
        "search": null,
        "search_value": null,
    ...
    onSearch = (text) => {
        ...
        let searches = totals.filter(x => 
            ...
            x.category_manufacturer.manufacturer.name.toLowerCase().includes(t)
            )
    ...
    componentDidMount = async() => {
        let totals = await api_stub_get("/consumable/")
    ...
    render(){
        ...
        return (
            <Layout>
                ...
                <ConsumableTable purchases={search != null ? search :totals}/>
...
export default ConsumableAssets;